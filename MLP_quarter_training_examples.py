...
train_labels_test = np.zeros((15000,1))
train_labels_test = train_labels[:15000,:]


train_labels_test_final = np.zeros((15000,10))

train_labels_final = np.full((60000, 10), 0.1, dtype=float)
train_labels_test_final = train_labels_final[:15000,:]
...
train_images_test = np.zeros((15000,785))
train_images_test = train_images[:15000,:]
...
h6 = np.zeros((15000,1))
finding_accuracy_train = np.zeros((15000,1))
...
for i in range(50):
    ...
    accuracy_train[i] = (diagonal_sum_train/15000.00)*100
